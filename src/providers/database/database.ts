...
private createTables(db: SQLiteObject) {
  ...
  db.sqlBatch([
    ...
    ['CREATE TABLE IF NOT EXISTS ocorrencias (codigo_ocorrencia INTEGER primary key AUTOINCREMENT NOT NULL, codigo_usuario INTEGER, codigo_tipo_ocorrencia INTEGER, titulo_ocorrencia TEXT, endereco_ocorrencia TEXT, posicao_ocorrencia TEXT, data_ocorrencia DATE, hora_ocorrencia DATETIME, boletim_ocorrencia BOOLEAN, FOREIGN KEY(codigo_usuario) REFERENCES usuarios(codigo_usuario), FOREIGN KEY(codigo_tipo_ocorrencia) REFERENCES tipos_de_ocorrencia(codigo_tipo_ocorrencia))']
